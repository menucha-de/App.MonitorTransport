			...
			new Thread(new Runnable() {
				...
				public void run() {
					try {
						socket.bind(null);
						ready.countDown();
						read("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><message xmlns=\"urn:havis:app:monitortransport:xsd:1\"><source>ReaderSource</source><name>Reader1</name><type>ConnectionError</type><state>true</state><timestamp>2019-01-08T15:09:27Z</timestamp><message>Connection failed</message></message>");
						read("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><message xmlns=\"urn:havis:app:monitortransport:xsd:1\"><source>TransportSource</source><name>tcp://test</name><type>TransportError</type><state>true</state><timestamp>2019-01-08T15:09:27Z</timestamp><message>Transport failed</message></message>");
					} catch (IOException e) {
						e.printStackTrace();
						Assert.fail();
					}
